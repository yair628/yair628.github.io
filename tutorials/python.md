...
# <i class="fab fa-python fa-fw fa-lg fa-notbold"></i> Python
...
​
I recommend <a href="https://www.sublimetext.com/" target="_blank">Sublime Text</a> for writing code.

**************************************************

## Fitzhugh-Nagumo --- Labyrinthine Patterns

{{< button href="http://nbviewer.jupyter.org/urls/bitbucket.org/yairmau/notebooks/raw/master/fhn_spectral.ipynb" >}}Jupyter notebook{{< /button >}}
...
{{< button href="http://nbviewer.jupyter.org/urls/bitbucket.org/yairmau/notebooks/raw/master/life.ipynb" >}}Jupyter notebook{{< /button >}}
...
{{< button href="http://nbviewer.jupyter.org/urls/bitbucket.org/yairmau/notebooks/raw/master/least-squares.ipynb" >}}Jupyter notebook{{< /button >}}
...
## Fun with histograms
{{< button href="http://nbviewer.jupyter.org/urls/bitbucket.org/yairmau/notebooks/raw/master/histogram.ipynb" >}}Jupyter notebook{{< /button >}}
...
## Fancy subplot grid
{{< button href="http://nbviewer.jupyter.org/urls/bitbucket.org/yairmau/notebooks/raw/master/subplot-grid.ipynb" >}}Jupyter notebook{{< /button >}}
...
## Streamplot
{{< button href="http://nbviewer.ipython.org/urls/bitbucket.org/yairmau/notebooks/raw/master/linear-system.ipynb" >}}Jupyter notebook{{< /button >}}
...
{{< button href="http://nbviewer.jupyter.org/urls/bitbucket.org/yairmau/notebooks/raw/master/tdgle.ipynb" >}}Jupyter notebook{{< /button >}}
...
{{< button href="http://nbviewer.jupyter.org/urls/bitbucket.org/yairmau/notebooks/raw/master/double-pendulum.ipynb" >}}Jupyter notebook{{< /button >}}
...
{{< button href="http://nbviewer.jupyter.org/urls/bitbucket.org/yairmau/notebooks/raw/master/hilbert-curve.ipynb" >}}Jupyter notebook{{< /button >}}
...
{{< button href="http://nbviewer.jupyter.org/urls/bitbucket.org/yairmau/notebooks/raw/master/hysteresis.ipynb" >}}Jupyter notebook{{< /button >}}
...
{{< button href="http://nbviewer.ipython.org/urls/bitbucket.org/yairmau/notebooks/raw/master/contours.ipynb" >}}Jupyter notebook{{< /button >}}
...
{{< button href="http://nbviewer.ipython.org/urls/bitbucket.org/yairmau/notebooks/raw/master/sea-sand.ipynb" >}}Jupyter notebook{{< /button >}}
...
{{< button href="http://nbviewer.ipython.org/urls/bitbucket.org/yairmau/notebooks/raw/master/website-logo.ipynb" >}}Jupyter notebook{{< /button >}}
...
{{< button href="http://nbviewer.ipython.org/urls/bitbucket.org/yairmau/notebooks/raw/master/bars.ipynb" >}}Jupyter notebook{{< /button >}}
